def draw_room(controller):
    ...
    # Draw shop items
    controller.draw_sprite('items', controller.shop.stock[0].id, x=17.5, y=42.5, rot=0, scale=6)
    controller.draw_sprite('items', controller.shop.stock[1].id, x=35.5, y=42.5, rot=0, scale=6)
    controller.draw_sprite('items', controller.shop.stock[2].id, x=53.5, y=42.5, rot=0, scale=6)
