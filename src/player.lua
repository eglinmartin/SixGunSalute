...
function Player:init(canvas, camera)
    ...
    local head_sprite_sheet = anim8.newGrid(18, 15, self.head_sprite_sheet_image:getWidth(), self.head_sprite_sheet_image:getHeight())
    self.animation_head = anim8.newAnimation(head_sprite_sheet(1, 1), 1)
...
function Player:draw()
    ...
    self.canvas:add_animated_sprite(self.animation, self.sprite_sheet_image, self.base_xy[1], self.base_xy[2], 28, 28, 0, 1, 0, true, false)
